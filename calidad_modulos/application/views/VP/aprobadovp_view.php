<div class="content-header row">
	<div class="content-header-left col-md-12 col-12 mb-2">
		<h2 class="content-header-title mb-0">
			<i class="fa ft-check-square"></i> SOLICITUDES APROBADAS VIVIENDA PILOTO
		</h2>
	</div>
</div>
		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">TABLA SOLICITUDES APROBADAS VIVIENDA PILOTO</h4>
...
<script type="text/javascript">
	var idObra;
	var controlador_vista = 'VP/Ctrl_aprobado/';
