...
class Ctrl_aprobado extends CI_Controller
{
  ...
  {
    $this->index();
    $this->template->set('titulo', 'VP Aprobados');
    $this->template->set('item_menu', 34);
  ...
  public function Listar()
  {
    ...
    $data[] = '';
    $url = $this->controller . 'viviendapiloto/' . $id . '-2-' . $idUsuario . '';
    $metodo = 'GET';
