...
class Ctrl_rechazado extends CI_Controller
{
  ...
  {
    $this->index();
    $this->template->set('titulo', 'VP Rechazados');
    $this->template->set('item_menu', 35);
  ...
  public function Listar()
  {
    ...
    $data[] = '';
    $url = $this->controller . 'viviendapiloto/' . $id . '-3-' . $idUsuario . '';
    $metodo = 'GET';
